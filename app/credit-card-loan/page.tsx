...
export default function LoanAgainstCreditCardPage() {
  return (
    <>
      <SubPageComponent
        title="Loan Against Credit Card"
        subTitle="Loan Against Credit Card"
        description="Loan Against Credit Card"
        buttonText="Apply Now"
        backgroundImage="https://www.jfs.in/docs/cms/assets/jfs/pdp/lending/instant-loans-desk.webp"
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Loan Against Credit Card" },
        ]}
      />
      <LoanHighlightSectionComponent
        highlights={[
          ...
          { tags: "variable", value: "2-3%", label: "Processing Fee" },
        ]}
      />
      ...
      <ReviewsSection loanType="Loan Against Credit Card" />
      <FAQSection />
    </>
  );
}
